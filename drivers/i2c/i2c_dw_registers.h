...
#define DW_IC_REG_ENABLE_STATUS (0x9C)
#define DW_IC_ENABLE_STATUS_IC_EN_BIT (0)
DEFINE_TEST_BIT_OP(enable_status_ic_en, DW_IC_REG_ENABLE_STATUS, DW_IC_ENABLE_STATUS_IC_EN_BIT)
